...
public class OpenFileDialog {
    ...
    public static Dialog createDialog(int id, Context context, String title, final CallBackBundle callback, String suffix, Map<String, Integer> images){
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                //应该是在这里开启下载图片到指定文件名的操作
                Bundle bundle = new Bundle();
                bundle.putString("path",nowPath);
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{
        ...
        private int refreshFileList()
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.tuji_dialog_layout, new String[]{"img", "name", "path"}, new int[]{R.id.tuji_dialog_img, R.id.tuji_dialog_name, R.id.tuji_dialog_path});
